...
- Add more `bad words` in our dictionary. We used these databases to collect bad words

| No.| Link|
|----|-----|
 1  | [link](https://huggingface.co/datasets/textdetox/multilingual_paradetox_test)
 | 2| [link](https://huggingface.co/datasets/textdetox/multilingual_toxicity_dataset)
 | 3 | [link](https://huggingface.co/textdetox)
